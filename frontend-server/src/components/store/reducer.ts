...
import { changeTagStatus, clearIdeaData, setAccessData, setConfig, setError, setHistory, setIdea, setIdeaData, setIdeaImage, setIdeaLoad, setIdeaSaved, setIdeas, setImageLoad, setModal, setTags, setUser } from './action';
